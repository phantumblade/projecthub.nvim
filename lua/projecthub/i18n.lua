...
M.locales = {
  it = {
    ...
    offline_tag = "SCOLLEGATO",
    external_box_where = "Il progetto vive qui:",
    external_box_how = "Ricollega l'unità '%s' per riaverne file e cronologia.",
    external_box_auto = "Torna da sola: nessun riavvio, nessun tasto da premere.",
    ...
    -- Divider fra i commit arrivati da upstream e il punto in cui sei sincronizzato
    incoming_divider_1 = "1 nuovo commit su %s",
    incoming_divider = "%d nuovi commit su %s",
    incoming_more = "... e altri %d in arrivo",
    incoming_synced = "sei aggiornato fino a qui",
    notify_incoming_1 = "'%s': 1 nuovo commit su %s",
    notify_incoming = "'%s': %d nuovi commit su %s",
    notify_incoming_many = "%d progetti con commit nuovi (%d in totale)",
    watch_on = "'%s': notifiche commit attivate",
    watch_off = "'%s': notifiche commit silenziate",
    ...
    notify_preview_body_connect = "Collegamento — usato quando un progetto viene riconnesso",
    notify_preview_body_snap = "Attività Git — usato quando lo stato di un repo cambia",
    notify_preview_body_toggle = "Interruttore — usato per lingua, audio e sorveglianza",
    notify_preview_body_open = "Apertura — usato per anteprime web e link GitHub",
    notify_preview_body_delete = "Rimozione — usato quando elimini un progetto o una nota",
    notify_preview_body_warn = "Avviso — usato quando qualcosa manca ma non è grave",
    notify_preview_body_error = "Errore — usato quando un'operazione fallisce",
  ...
  en = {
    ...
    offline_tag = "OFFLINE",
    external_box_where = "The project lives here:",
    external_box_how = "Plug drive '%s' back in to get its files and history.",
    external_box_auto = "It returns on its own: no restart, no key to press.",
    ...
    -- Divider between commits fetched from upstream and your synced point
    incoming_divider_1 = "1 new commit on %s",
    incoming_divider = "%d new commits on %s",
    incoming_more = "... and %d more incoming",
    incoming_synced = "you are up to date here",
    notify_incoming_1 = "'%s': 1 new commit on %s",
    notify_incoming = "'%s': %d new commits on %s",
    notify_incoming_many = "%d projects with new commits (%d in total)",
    watch_on = "'%s': commit notifications on",
    watch_off = "'%s': commit notifications muted",
    ...
    notify_preview_body_connect = "Connection — used when a project is reconnected",
    notify_preview_body_snap = "Git activity — used when a repo's state changes",
    notify_preview_body_toggle = "Switch — used for language, audio and the watcher",
    notify_preview_body_open = "Opening — used for web previews and GitHub links",
    notify_preview_body_delete = "Removal — used when you delete a project or note",
    notify_preview_body_warn = "Warning — used when something is missing but not fatal",
    notify_preview_body_error = "Error — used when an operation fails",
