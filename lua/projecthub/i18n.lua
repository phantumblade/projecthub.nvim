...
M.locales = {
  it = {
    ...
    star_status_on = "Sorveglianza attiva · %d repo · %d stelle in totale · controllo ogni %ds",
    star_status_off = "Sorveglianza ferma · %d repo noti · %d stelle in totale",
  ...
  en = {
    ...
    star_status_on = "Watching · %d repos · %d stars total · checking every %ds",
    star_status_off = "Stopped · %d repos known · %d stars total",
